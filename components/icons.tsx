...
export const Icons = {
  ...
  logo: (props: LucideProps) => (
    <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path
        d="M12 9.5h6.4c2.92 0 5.1 2.2 5.1 5 0 2.48-1.56 4.3-3.9 4.85l4.04 5.15h-4.02l-3.66-4.84h-1.92v4.84H12V9.5zm6.04 6.86c1.44 0 2.43-.92 2.43-2.12 0-1.18-.93-2-2.4-2H15.6v4.12h2.44z"
        fill="white"
      />
    </svg>
  ),
...
cookie: (props: LucideProps) => (
<svg clipRule="evenodd" fillRule="evenodd" height="512" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg" {...props}>

<g id="Icon"><path fill="currentColor" d="m22.624 10.348c.083.539.126 1.09.126 1.652 0 5.933-4.817 10.75-10.75 10.75s-10.75-4.817-10.75-10.75 4.817-10.75 10.75-10.75c.459 0 .911.029 1.355.085.239.03.448.172.564.383.115.21.123.464.021.681-.122.258-.19.547-.19.851 0 .65.311 1.228.792 1.593.232.177.341.473.278.759-.046.209-.07.425-.07.648 0 1.656 1.344 3 3 3 .099 0 .196-.005.293-.014.25-.024.495.078.654.273.367.452.926.741 1.553.741.444 0 .855-.145 1.187-.39.211-.156.488-.191.731-.091s.415.32.456.579zm-5.874 3.402c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25zm-7.5 2.5c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25zm.24-10.8c-.414 0-.75.336-.75.75s.336.75.75.75.75-.336.75-.75-.336-.75-.75-.75zm2.76 8.3c-.414 0-.75.336-.75.75s.336.75.75.75.75-.336.75-.75-.336-.75-.75-.75zm-5.75-3c-.414 0-.75.336-.75.75s.336.75.75.75.75-.336.75-.75-.336-.75-.75-.75zm4.75-2.25c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25z"/></g></svg>
),
}
