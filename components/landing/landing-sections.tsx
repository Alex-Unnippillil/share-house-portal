              ...
              <div className="relative flex items-center justify-between border-b border-white/10 px-5 py-4 sm:px-6">
                <div className="flex items-center gap-3">
                  ...
                  <div className="leading-tight">
                    <p className="text-sm font-semibold text-primary-foreground">Roomsily</p>
                    <p className="text-xs text-primary-foreground/70">Shared-home command center</p>
                  </div>
                </div>
              ...
              <div className="relative space-y-4 p-5 sm:p-6">
                ...
                <div className="rounded-2xl border border-primary-foreground/20 bg-background/10 p-4 backdrop-blur">
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    <p className="text-sm font-medium text-primary-foreground">Household health</p>
                    <p className="text-xs text-booking-confirmed-background">All systems normal</p>
                  </div>
