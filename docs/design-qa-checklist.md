...
Use this checklist before merging UI changes that touch landing pages, dashboard routes, or settings forms.
...
- [ ] Landing sections use the shared layout content container so text and cards align consistently.
...
- [ ] Sticky headers and shell wrappers preserve spacing when navigating between landing and dashboard routes.

## Regression Spot Checks

- [ ] Root layout shell renders correctly with global providers and suspense boundaries.
- [ ] Landing hero + downstream sections preserve consistent top/bottom rhythm between sections.
