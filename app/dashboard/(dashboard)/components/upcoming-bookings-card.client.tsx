...
import type { UpcomingBooking } from "../data"
...
interface UpcomingBookingsCardClientProps {
  bookings: UpcomingBooking[]
}

export function UpcomingBookingsCardClient({ bookings }: UpcomingBookingsCardClientProps) {
      ...
      <CardContent className="space-y-4">
        <ul className="space-y-3">
          {bookings.map((booking) => {
            ...
            return (
              <li key={booking.id} className="rounded-lg border border-border/60 p-3 shadow-sm">
