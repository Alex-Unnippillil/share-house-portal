...
interface RecentDocumentsCardClientProps {
  documents: DocumentSummary[]
}

export function RecentDocumentsCardClient({ documents }: RecentDocumentsCardClientProps) {
              ...
              >
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">
                    {document.category} • Updated {formatDate(document.updatedAt, { month: "short", day: "numeric" })}
                  </p>
                </div>
